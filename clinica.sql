...
BEGIN
	...
	SET @saida = 'Login válido.'
END
ELSE
BEGIN
	SET @saida = 'Login inválido.'
END 
...
GO
/*
• O cadastro de consultas, com dia, hora e especialidade, deve seguir as
regras de marcação descritas acima
• Para cadastrar uma consulta ou verificar consultas cadastradas, deve se
fazer acesso por login e senha
• O cliente pode ver o histórico de suas consultas passadas e futuras
